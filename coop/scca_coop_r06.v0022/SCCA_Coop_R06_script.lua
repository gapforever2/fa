-- ****************************************************************************
-- **
-- **  File     : /maps/scca_coop_r06.v0022/SCCA_Coop_R06_script.lua
...
local OpStrings = import('/maps/scca_coop_r06.v0022/SCCA_Coop_R06_strings.lua')
...
function SpawnUEF()
    ...
    ScenarioInfo.Aiko:CreateEnhancement('HeavyAntiMatterCannonUEF')
    ScenarioInfo.Aiko:CreateEnhancement('ShieldUEF')
    ScenarioInfo.Aiko:CreateEnhancement('HeavyAntiMatterCannonUEF')
    ScenarioInfo.Aiko:CreateEnhancement('DamageStabilizationUEF')
...
function SpawnAeon()
    ...
    ScenarioInfo.Arnold:CreateEnhancement('ShieldAeon')
    ScenarioInfo.Arnold:CreateEnhancement('HeatSinkAeon')
	ScenarioInfo.Arnold:CreateEnhancement('ResourceAllocationAeon')
