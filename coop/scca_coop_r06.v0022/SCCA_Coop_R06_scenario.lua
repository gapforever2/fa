...
ScenarioInfo = {
    ...
    size = {1024, 1024},
    map = '/maps/scca_coop_r06.v0022/SCCA_E06.scmap',
    save = '/maps/scca_coop_r06.v0022/SCCA_Coop_R06_save.lua',
    script = '/maps/scca_coop_r06.v0022/SCCA_Coop_R06_script.lua',
    Configurations = {
        ['standard'] = {
            teams = {
