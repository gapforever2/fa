-- ****************************************************************************
-- **
-- **  File     :  /maps/scca_coop_r04.v0019/SCCA_Coop_R04_script.lua
...
local M1AeonAI = import('/maps/scca_coop_r04.v0019/SCCA_Coop_R04_m1aeonai.lua')
local M3AeonAI = import('/maps/scca_coop_r04.v0019/SCCA_Coop_R04_m3aeonai.lua')
local NukeDamage = import('/lua/sim/NukeDamage.lua').NukeAOE
local Objectives = import('/lua/SimObjectives.lua')
local OpStrings = import('/maps/scca_coop_r04.v0019/SCCA_Coop_R04_strings.lua')
...
function OnPopulate(scenario)
    ...
    ScenarioInfo.ErisACU = ScenarioFramework.SpawnCommander('Aeon', 'M1_Commander', false, LOC '{i CDR_Eris}', false, false,
        {'EngineeringT2Aeon', 'TeleporterAeon', 'EnhancedSensorsAeon'})
...
function OnStart(self)
    ...
    ScenarioFramework.RestrictEnhancements({
        'MicrowaveLaserGeneratorCybran',
        'CloakingGeneratorCybran',
        'T3EngineeringCybran',
        'TeleporterCybran',
   })
