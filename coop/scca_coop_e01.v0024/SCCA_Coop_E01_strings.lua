...
E01_M01_034 = {
  {text = '[{i Arnold}]: Постройте Бронетанковый завод Командующий', vid = 'E01_Arnold_M01_0004.sfd', bank = 'E01_VO', cue = 'E01_Arnold_M01_0004', faction = 'UEF'},
}
...
-- Primary Objectives
OpE01_M1P1_Title = 'Постройте четыре силовых генератора'

-- Primary Objectives
OpE01_M1P1_Desc = 'Выберите вашу боевую машину командующего (БМК), щелкните по иконке и постройте возле или чуть поодаль 4 силовых генератора'

-- Primary Objectives
OpE01_M1P2_Title = 'Постройте экстракторы материи'

-- Primary Objectives
OpE01_M1P2_Desc = 'Выберите вашу боевую машину командующего (БМК), щелкните по иконке и постройте на месторождениях экстракторы (другим игрокам так же стоит сделать)'
...
-- Primary Objectives
OpE01_M2P1_Title = 'Постройте наземную фабрику'

-- Primary Objectives
OpE01_M2P1_Desc = 'Выберите фабрику среди доступных чертежей вашего бмк и постройте фабрику возле генераторов или экстракторов (рекомендуем, если вы построите фабрику возле экстракторов материи и возле генераторов, это даст вам скидку на производство юнитов с фабрик. Это относится и к строительство генераторов Т1 возле экстракторов материи)'
...
-- Primary Objectives
OpE01_M3P1_Title = 'Постройте 4 легких танка на ваших фабриках'

OpE01_M3P2_Title = 'Постройте на фабриках 4 легких артиллерии.'



-- Primary Objectives
OpE01_M3P1_Desc = 'На наземном заводе есть иконка легких танков "МА12 Гарпун" вам нужно это.'

OpE01_M3P2_Desc = 'На наземном заводе есть иконка легкой артилерии "Волк", постройте 4 юнита.'
...
GodJopF_1 = {
  {text = '[{i Arnold}]: Хорошая работа командующий, используйте их как нужно.', vid = 'E01_Arnold_M04_0010.sfd', bank = 'E01_VO', cue = 'E01_Arnold_M03_00677', faction = 'UEF'},
}
