-- ****************************************************************************
-- **
-- **  File     : /maps/x1ca_coop_006.v0022/X1CA_Coop_006_m2seraphimai.lua
...
function SeraphimM2BaseAirAttacks()
    ...
    opai = SeraphimM2Base:AddOpAI('AirAttacks', 'M2_SeraphimAirAttacks1',
        {
            MasterPlatoonFunction = {'/maps/x1ca_coop_006.v0022/X1CA_Coop_006_m2seraphimai.lua', 'M2SeraphimAirAttackAI'},
            Priority = 100,
        }
    )
...
function SeraphimM2BaseNavalAttacks()
    ...
    opai = SeraphimM2Base:AddNavalAI('M2_SeraphimNavalAttack1',
        {
            MasterPlatoonFunction = {'/maps/x1ca_coop_006.v0022/X1CA_Coop_006_m2seraphimai.lua', 'M2SeraphimNavalAttackAI'},
            MaxFrigates = 20,
            MinFrigates = 20,
            Priority = 100,
        }
