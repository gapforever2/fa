...
ScenarioInfo = {
    ...
    map = '/maps/x1ca_coop_001.v0031/X1CA_Coop_001.scmap',
    save = '/maps/x1ca_coop_001.v0031/X1CA_Coop_001_save.lua',
    script = '/maps/x1ca_coop_001.v0031/X1CA_Coop_001_script.lua',
    Configurations = {
        ['standard'] = {
            teams = {
