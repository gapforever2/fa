-- ****************************************************************************
-- **
-- **  File     :  /maps/scca_coop_a06.v0025/SCCA_Coop_A06_script.lua
...
local CustomFunctions = import('/maps/scca_coop_a06.v0025/SCCA_Coop_A06_CustomFunctions.lua')
local M2CybranAI = import('/maps/scca_coop_a06.v0025/SCCA_Coop_A06_m2cybranai.lua')
local M3AeonAI = import('/maps/scca_coop_a06.v0025/SCCA_Coop_A06_m3aeonai.lua')
local Objectives = import('/lua/SimObjectives.lua')
local OpStrings = import ('/maps/scca_coop_a06.v0025/SCCA_Coop_A06_strings.lua')
...
function IntroMission2()
    ...
    ScenarioInfo.CybranCommander = ScenarioFramework.SpawnCommander('Cybran', 'Commander', false, LOC '{i RedFog}', true, M2CybranCommanderKilled,
        {'EngineeringT2Cybran', 'T3EngineeringCybran', 'StealthGeneratorCybran', 'CloakingGeneratorCybran', 'MicrowaveLaserGeneratorCybran'})
    ...
    ScenarioInfo.CybranSubCommander = ScenarioFramework.SpawnCommander('Cybran', 'SubCommander', false, LOC '{i sCDR_Jericho}', false, M2CybranCommanderKilled,
        {'NaniteMissileSystem', 'ResourceAllocation', 'StealthGenerator'})
...
function IntroMission3()
    ...
    -- Marxon
    ScenarioInfo.AeonCommander = ScenarioFramework.SpawnCommander('Aeon', 'AeonEvilCommander', false, LOC '{i Marxon}', true, false,
        { 'ShieldHeavyAeon', 'EnhancedSensorsAeon', 'EngineeringT2Aeon'})
    ...
    ScenarioInfo.FriendlyCommander = ScenarioFramework.SpawnCommander('Aeon', 'Friendly_Commander', false, LOC '{i CDR_Arnold}', false, false,
        {'HeatSinkAeon', 'GAP_CrysalisBeamAdvancedAeon', 'ShieldAeon', 'EnhancedSensorsAeon'})
