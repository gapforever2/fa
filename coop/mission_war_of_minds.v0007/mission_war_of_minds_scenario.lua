...
ScenarioInfo = {
    ...
    map = '/maps/mission_war_of_minds.v0007/mission_war_of_minds.scmap',
    save = '/maps/mission_war_of_minds.v0007/mission_war_of_minds_save.lua',
    script = '/maps/mission_war_of_minds.v0007/mission_war_of_minds_script.lua',
    norushradius = 0,
    Configurations = {
        ['standard'] = {
            teams = {
