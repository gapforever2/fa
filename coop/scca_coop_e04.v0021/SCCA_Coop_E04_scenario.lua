...
ScenarioInfo = {
    ...
    size = {512, 512},
    map = '/maps/scca_coop_e04.v0021/SCCA_Coop_E04.scmap',
    save = '/maps/scca_coop_e04.v0021/SCCA_Coop_E04_save.lua',
    script = '/maps/scca_coop_e04.v0021/SCCA_Coop_E04_script.lua',
    Configurations = {
        ['standard'] = {
            teams = {
                { name = 'FFA', armies = {'Player1','Cybran','Cybran_Research','Player2','Player3','Player4'} },
            },
            customprops = {
            },
