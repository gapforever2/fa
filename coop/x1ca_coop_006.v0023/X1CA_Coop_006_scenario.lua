...
ScenarioInfo = {
    ...
    save = '/maps/x1ca_coop_006.v0023/X1CA_Coop_006_save.lua',
    script = '/maps/x1ca_coop_006.v0023/X1CA_Coop_006_script.lua',
    Configurations = {
        ['standard'] = {
            teams = {
            ...
            factions = { {'uef', 'aeon', 'cybran'}, {'aeon'}, {'uef'}, {'uef', 'aeon', 'cybran'} },
        },
    }}
