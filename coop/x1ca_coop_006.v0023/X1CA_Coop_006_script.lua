-- ****************************************************************************
-- **
-- **  File     :  /maps/x1ca_coop_006.v0023/X1CA_Coop_006_script.lua
...
local M1SeraphimAI = import('/maps/x1ca_coop_006.v0023/X1CA_Coop_006_m1seraphimai.lua')
local M2FletcherAI = import('/maps/x1ca_coop_006.v0023/X1CA_Coop_006_m2fletcherai.lua')
local M2OrderAI = import('/maps/x1ca_coop_006.v0023/X1CA_Coop_006_m2orderai.lua')
local M2RhizaAI = import('/maps/x1ca_coop_006.v0023/X1CA_Coop_006_m2rhizaai.lua')
local M2SeraphimAI = import('/maps/x1ca_coop_006.v0023/X1CA_Coop_006_m2seraphimai.lua')
local M3SeraphimAI = import('/maps/x1ca_coop_006.v0023/X1CA_Coop_006_m3seraphimai.lua')
local Objectives = import('/lua/ScenarioFramework.lua').Objectives
local OpStrings = import('/maps/x1ca_coop_006.v0023/X1CA_Coop_006_strings.lua')
...
-- Taunt Managers
----------------
local VedettaTM = TauntManager.CreateTauntManager('VedettaTM', '/maps/x1ca_coop_006.v0023/X1CA_Coop_006_Strings.lua')
local FletcherTM = TauntManager.CreateTauntManager('FletcherTM', '/maps/x1ca_coop_006.v0023/X1CA_Coop_006_Strings.lua')
local TauTM = TauntManager.CreateTauntManager('TauTM', '/maps/x1ca_coop_006.v0023/X1CA_Coop_006_Strings.lua')
local HQTM = TauntManager.CreateTauntManager('HQTM', '/maps/x1ca_coop_006.v0023/X1CA_Coop_006_Strings.lua')
local RhizaTM = TauntManager.CreateTauntManager('RhizaTM', '/maps/x1ca_coop_006.v0023/X1CA_Coop_006_Strings.lua')
...
function M2Fletcher()
    ...
    if(Difficulty > 1) then
        ScenarioInfo.FletcherACU:CreateEnhancement('DamageStabilizationUEF')
        ScenarioInfo.FletcherACU:CreateEnhancement('HeavyAntiMatterCannonUEF')
        ScenarioInfo.FletcherACU:CreateEnhancement('ShieldUEF')
        ScenarioInfo.FletcherACU:CreateEnhancement('ShieldGeneratorFieldUEF')
    end
...
function M2Order()
    ...
    if(Difficulty > 1) then
        ScenarioInfo.OrderACU:CreateEnhancement('ShieldAeon')
        ScenarioInfo.OrderACU:CreateEnhancement('ShieldHeavyAeon')
        ScenarioInfo.OrderACU:CreateEnhancement('HeatSinkAeon')
		ScenarioInfo.OrderACU:CreateEnhancement('GAP_CrysalisBeamAdvancedAeon')
		ScenarioInfo.OrderACU:CreateEnhancement('EngineeringT2Aeon')
		ScenarioInfo.OrderACU:CreateEnhancement('T3EngineeringAeon')
    end
...
function M2Rhiza()
    ...
    ScenarioInfo.RhizaACU = ScenarioFramework.SpawnCommander('Rhiza', 'M2_Rhiza', false, LOC '{i Rhiza}', false, RhizaDies, 
        {'ShieldAeon', 'ShieldHeavyAeon', 'EngineeringT2Aeon', 'T3EngineeringAeon', 'HeatSinkAeon', 'GAP_CrysalisBeamAdvancedAeon'})
...
function IntroMission3()
    ForkThread(
        function()
            ...
            if(Difficulty > 1) then
                ScenarioInfo.Tau:CreateEnhancement('DamageStabilizationAdvancedSeraphim')
                ScenarioInfo.Tau:CreateEnhancement('RateOfFireSeraphim')
                ScenarioInfo.Tau:CreateEnhancement('BlastAttackSeraphim')
				ScenarioInfo.Tau:CreateEnhancement('RegenAuraSeraphim')
				ScenarioInfo.Tau:CreateEnhancement('EngineeringT2Seraphim')
				ScenarioInfo.Tau:CreateEnhancement('T3EngineeringSeraphim')
            end
