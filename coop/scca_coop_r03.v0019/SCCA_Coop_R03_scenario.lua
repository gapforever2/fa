...
ScenarioInfo = {
    ...
    size = {512, 512},
    map = '/maps/scca_coop_r03.v0019/SCCA_Coop_R03.scmap',
    save = '/maps/scca_coop_r03.v0019/SCCA_Coop_R03_save.lua',
    script = '/maps/scca_coop_r03.v0019/SCCA_Coop_R03_script.lua',
    Configurations = {
        ['standard'] = {
            teams = {
