...
ScenarioInfo = {
    ...
    map = '/maps/scca_coop_a03.v0022/SCCA_Coop_A03.scmap',
    save = '/maps/scca_coop_a03.v0022/SCCA_Coop_A03_save.lua',
    script = '/maps/scca_coop_a03.v0022/SCCA_Coop_A03_script.lua',
    norushradius = 0,
    Configurations = {
        ['standard'] = {
            teams = {
