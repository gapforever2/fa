...
ScenarioInfo = {
    ...
    size = {512, 512},
    map = '/maps/scca_coop_r02.v0020/SCCA_Coop_R02.scmap',
    save = '/maps/scca_coop_r02.v0020/SCCA_Coop_R02_save.lua',
    script = '/maps/scca_coop_r02.v0020/SCCA_Coop_R02_script.lua',
    Configurations = {
        ['standard'] = {
            teams = {
