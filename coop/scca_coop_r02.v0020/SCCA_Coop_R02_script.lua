-- ****************************************************************************
-- **
-- **  File     :  /maps/scca_coop_r02.v0020/SCCA_Coop_R02_script.lua
...
local OpStrings = import('/maps/scca_coop_r02.v0020/SCCA_Coop_R02_strings.lua')
local OpEditorFns = import ('/maps/scca_coop_r02.v0020/SCCA_Coop_R02_EditorFunctions.lua')
...
function M1JanusLeaves()
    ...
    m1JanusCDRUnit:CreateEnhancement('TeleporterCybran')
...
function M1GiveTech()
    ...
    ScenarioFramework.RestrictEnhancements({'EngineeringT2Cybran', -- 1
                                            'CloakingGeneratorCybran',
                                            'T3EngineeringCybran',
                                            'NaniteTorpedoTubeCybran',
