-- ****************************************************************************
-- **
-- **  File     :  /maps/scca_coop_r05.v0021/SCCA_Coop_R05_script.lua
-- **  Author(s):  Greg
-- **
-- **  Summary  :
-- **
...
local OpStrings   = import('/maps/scca_coop_r05.v0021/SCCA_Coop_R05_Strings.lua')
...
function M3_CreateUnitsForMission()
    ...
    ScenarioInfo.M3_UEFMainBase_Commander:CreateEnhancement( 'ShieldGeneratorFieldUEF' )
    ScenarioInfo.M3_UEFMainBase_Commander:CreateEnhancement( 'ResourceAllocationUEF' )
    ScenarioInfo.M3_UEFMainBase_Commander:CreateEnhancement( 'DamageStabilizationUEF' )
    ...
    for _, player in Players do
        for iArmy, strArmy in pairs(tblArmy) do
            if iArmy == player then
                ...
                ScenarioFramework.RestrictEnhancements({'StealthGeneratorCybran', -- 5
                                            'TeleporterCybran'})
            end
        end
    end
