-- ****************************************************************************
-- **
-- **  File     :  /maps/scca_coop_r03.v0020/SCCA_Coop_R03_script.lua
...
local OpStrings = import ('/maps/scca_coop_r03.v0020/SCCA_Coop_R03_strings.lua')
...
function IntroSequenceThread()
    ...
    ScenarioInfo.PlayerCDR = ScenarioFramework.SpawnCommander('Player1', 'Commander', 'Gate', true, true, OnCommanderDeath)
...
function GiveMission1Tech()
    ...
    -- Commander
    ScenarioFramework.RestrictEnhancements({'T3EngineeringCybran',
