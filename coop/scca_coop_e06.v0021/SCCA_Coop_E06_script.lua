-- ****************************************************************************
-- **
-- **  File     :  /maps/scca_coop_e06.v0021/SCCA_Coop_E06_script.lua
...
local OpStrings = import('/maps/scca_coop_e06.v0021/SCCA_Coop_E06_Strings.lua')
...
function StartMission2()
    ...
    aeonCDR[1]:CreateEnhancement('ShieldAeon')
    aeonCDR[1]:CreateEnhancement('EngineeringT2Aeon')
	aeonCDR[1]:CreateEnhancement('T3EngineeringAeon')
	aeonCDR[1]:CreateEnhancement('ResourceAllocationAeon')
	aeonCDR[1]:CreateEnhancement('ResourceAllocationAdvancedAeon')
...
function StartMission3()
    if ScenarioInfo.MissionNumber ~= 3 then
        ...
        ScenarioInfo.ArnoldPlatoon:GetPlatoonUnits()[1]:CreateEnhancement('ShieldAeon')
        ScenarioInfo.ArnoldPlatoon:GetPlatoonUnits()[1]:CreateEnhancement('ResourceAllocationAeon')
        ScenarioInfo.ArnoldPlatoon:GetPlatoonUnits()[1]:CreateEnhancement('HeatSinkAeon')
		ScenarioInfo.ArnoldPlatoon:GetPlatoonUnits()[1]:CreateEnhancement('GAP_CrysalisBeamAdvancedAeon')
