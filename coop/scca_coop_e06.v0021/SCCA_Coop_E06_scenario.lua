...
ScenarioInfo = {
    ...
    size = {1024, 1024},
    map = '/maps/scca_coop_e06.v0021/SCCA_Coop_E06.scmap',
    save = '/maps/scca_coop_e06.v0021/SCCA_Coop_E06_save.lua',
    script = '/maps/scca_coop_e06.v0021/SCCA_Coop_E06_script.lua',
    Configurations = {
        ['standard'] = {
            teams = {
