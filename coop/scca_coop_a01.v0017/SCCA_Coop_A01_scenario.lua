...
ScenarioInfo = {
    ...
    size = {512, 512},
    map = '/maps/scca_coop_a01.v0017/SCCA_Coop_A01.scmap',
    save = '/maps/scca_coop_a01.v0017/SCCA_Coop_A01_save.lua',
    script = '/maps/scca_coop_a01.v0017/SCCA_Coop_A01_script.lua',
    Configurations = {
        ['standard'] = {
            teams = {
