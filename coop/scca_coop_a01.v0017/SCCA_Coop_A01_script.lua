-- ****************************************************************************
-- **
-- **  File     :  /maps/scca_coop_a01.v0017/SCCA_Coop_A01_script.lua
-- **  Author(s):  Greg
-- **
-- **  Summary  :
-- **
...
local OpStrings   = import('/maps/scca_coop_a01.v0017/SCCA_Coop_A01_Strings.lua')
...
function M7_BeginMission()
    ...
    ScenarioInfo.M7_FauxUEFCommanderUnit:CreateEnhancement('ShieldGeneratorFieldUEF')
    ...
    ScenarioInfo.M7_RhizaCommanderUnit:CreateEnhancement('ShieldAeon')
...
function BuildCategories1()
    ...
    ScenarioFramework.RestrictEnhancements({'EngineeringT2Aeon',
                                            'ChronoDampenerAeon',
                                            'EnhancedSensorsAeon',
                                            'T3EngineeringAeon',
                                            'HeatSinkAeon',
