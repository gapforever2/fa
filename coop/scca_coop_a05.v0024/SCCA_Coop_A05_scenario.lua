...
ScenarioInfo = {
    ...
    map_version = 3,
    size = {1024, 1024},
    map = '/maps/scca_coop_a05.v0024/SCCA_Coop_A05.scmap',
    save = '/maps/scca_coop_a05.v0024/SCCA_Coop_A05_save.lua',
    script = '/maps/scca_coop_a05.v0024/SCCA_Coop_A05_script.lua',
