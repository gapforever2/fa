...
function Intro_Mission_3()
    ...
    ScenarioInfo.CybranCommander = ScenarioFramework.SpawnCommander('Cybran', 'ACU', false, "Jerrax", false, false, {'MicrowaveLaserGeneratorCybran', 'TeleporterCybran', 'T3EngineeringCybran'})
...
function M3Trucks()
    ...
    ScenarioInfo.TEngineer1 = ScenarioUtils.CreateArmyUnit('UEF', 'TEngineerT2_1')
	ScenarioInfo.TEngineer2 = ScenarioUtils.CreateArmyUnit('UEF', 'TEngineerT2_2')
	ScenarioInfo.TEngineer3 = ScenarioUtils.CreateArmyUnit('UEF', 'TEngineerT2_3')
	ScenarioInfo.TEngineer4 = ScenarioUtils.CreateArmyUnit('UEF', 'TEngineerT2_4')
	...
	ScenarioInfo.HeavyTrans_4 = ScenarioInfo.UnitNames[UEF]['Tran_4']
    ...
    ScenarioFramework.AttachUnitsToTransports({ScenarioInfo.TEngineer1}, {ScenarioInfo.HeavyTrans_3})
	ScenarioFramework.AttachUnitsToTransports({ScenarioInfo.TEngineer2}, {ScenarioInfo.HeavyTrans_4})
	ScenarioFramework.AttachUnitsToTransports({ScenarioInfo.TEngineer3}, {ScenarioInfo.HeavyTrans_4})
	ScenarioFramework.AttachUnitsToTransports({ScenarioInfo.TEngineer4}, {ScenarioInfo.HeavyTrans_3})
	...
	IssueTransportUnload({ScenarioInfo.HeavyTrans_4}, ScenarioUtils.MarkerToPosition('M3_UEF_Trans_Move'))
