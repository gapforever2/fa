...
ScenarioInfo = {
    ...
    size = {512, 512},
    map = '/maps/scca_coop_e03.v0021/SCCA_Coop_E03.scmap',
    save = '/maps/scca_coop_e03.v0021/SCCA_Coop_E03_save.lua',
    script = '/maps/scca_coop_e03.v0021/SCCA_Coop_E03_script.lua',
    Configurations = {
        ['standard'] = {
            teams = {
