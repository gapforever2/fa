-- ****************************************************************************
-- **
-- **  File     :  /maps/scca_coop_e03.v0022/SCCA_Coop_E03_script.lua
...
local OpStrings = import('/maps/scca_coop_e03.v0022/SCCA_Coop_E03_strings.lua')
...
function OnPopulate(scenario)
    ...
    ScenarioInfo.AeonCDR:CreateEnhancement('CrysalisBeamAeon')
...
function OnStart(self)
    ...
    ScenarioFramework.RestrictEnhancements({'T3EngineeringUEF',
                                            'RightPod',
