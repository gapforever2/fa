-- ****************************************************************************
-- **
-- **  File     :  /maps/scca_coop_e05.v0023/SCCA_Coop_E05_script.lua
...
local OpStrings = import ('/maps/scca_coop_e05.v0023/SCCA_Coop_E05_strings.lua')
local OpEditorFns = import ('/maps/scca_coop_e05.v0023/SCCA_Coop_E05_EditorFunctions.lua')
...
function OnPopulate(scenario)
    ...
    ScenarioFramework.RestrictEnhancements({'TacticalNukeMissileUEF', 'TeleporterUEF'})
end
...
function StartMission2()
    ...
    ScenarioInfo.CybranCDR:CreateEnhancement('EngineeringT2Cybran')
    ScenarioInfo.CybranCDR:CreateEnhancement('MicrowaveLaserGeneratorCybran')
    ScenarioInfo.CybranCDR:CreateEnhancement('CloakingGeneratorCybran')
    ...
    ScenarioInfo.AeonCDR:CreateEnhancement('EngineeringT2Aeon')
    ScenarioInfo.AeonCDR:CreateEnhancement('ChronoDampenerAeon')
    ScenarioInfo.AeonCDR:CreateEnhancement('HeatSinkAeon')
	ScenarioInfo.AeonCDR:CreateEnhancement('ShieldAeon')
    ScenarioInfo.AeonCDR:CreateEnhancement('ShieldHeavyAeon')
