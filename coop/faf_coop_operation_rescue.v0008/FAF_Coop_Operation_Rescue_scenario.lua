...
ScenarioInfo = {
    ...
    map = '/maps/faf_coop_operation_rescue.v0008/FAF_Coop_Operation_Rescue.scmap',
    save = '/maps/faf_coop_operation_rescue.v0008/FAF_Coop_Operation_Rescue_save.lua',
    script = '/maps/faf_coop_operation_rescue.v0008/FAF_Coop_Operation_Rescue_script.lua',
    norushradius = 0,
    Configurations = {
        ['standard'] = {
            teams = {
