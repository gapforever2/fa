-- ****************************************************************************
-- **
-- **  File     :  /maps/scca_coop_a05.v0025/SCCA_Coop_A05_script.lua
...
-- ****************************************************************************
local M1ArielAI = import('/maps/scca_coop_a05.v0025/SCCA_Coop_A05_m1arielai.lua')
local M2UEFAI = import('/maps/scca_coop_a05.v0025/SCCA_Coop_A05_m2uefai.lua')
local M3ArielAI = import('/maps/scca_coop_a05.v0025/SCCA_Coop_A05_m3arielai.lua')
local Objectives = import('/lua/SimObjectives.lua')
local OpStrings = import('/maps/scca_coop_a05.v0025/SCCA_Coop_A05_Strings.lua')
...
function OnStart(self)
    ...
    ScenarioFramework.RestrictEnhancements({'TeleporterAeon'})
...
function IntroMission2()
    ...
    ScenarioInfo.BlakeUnit = ScenarioFramework.SpawnCommander('UEF', 'Blake_Unit', false, LOC '{i CDR_Blake}', true, false,
        {'ShieldUEF', 'DamageStabilizationUEF', 'ResourceAllocationUEF'})
...
function IntroMission3()
    ...
    ScenarioInfo.ArielCDR = ScenarioFramework.SpawnCommander('Ariel', 'Ariel_ACU', false, LOC '{i CDR_Ariel}', true, false,
        {'HeatSinkAeon', 'ShieldAeon', 'ShieldHeavyAeon', 'ResourceAllocationAeon'})
