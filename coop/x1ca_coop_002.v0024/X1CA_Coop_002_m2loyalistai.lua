-- ****************************************************************************
-- **
-- **  File     : /maps/x1ca_coop_002.v0024/X1CA_Coop_002_m2loyalistai.lua
...
function LoyalistM2EastBaseAirAttacks()
    ...
    opai = LoyalistM2EastBase:AddOpAI('AirAttacks', 'M2_AirAttacks',
        {
            MasterPlatoonFunction = {'/maps/x1ca_coop_002.v0024/X1CA_Coop_002_m2loyalistai.lua', 'LoyalistM2EastAirAttacksAI'},
        }
    )
...
function LoyalistM2EastBaseLandAttacks()
    ...
    opai = LoyalistM2EastBase:AddOpAI('BasicLandAttack', 'M2_LandAttackEast',
        {
            MasterPlatoonFunction = {'/maps/x1ca_coop_002.v0024/X1CA_Coop_002_m2loyalistai.lua', 'LoyalistM2EastLandAttacksAI'},
        }
    )
...
function LoyalistM2WestBaseLandAttacks()
    ...
    opai = LoyalistM2WestBase:AddOpAI('BasicLandAttack', 'M2_LandAttackWest',
        {
            MasterPlatoonFunction = {'/maps/x1ca_coop_002.v0024/X1CA_Coop_002_m2loyalistai.lua', 'LoyalistM2WestLandAttacksAI'},
        }
    )
    opai:SetChildActive('MobileShields', false)
end
