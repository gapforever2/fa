...
ScenarioInfo = {
    ...
    size = {512, 512},
    map = '/maps/scca_coop_r01.v0018/SCCA_Coop_R01.scmap',
    save = '/maps/scca_coop_r01.v0018/SCCA_Coop_R01_save.lua',
    script = '/maps/scca_coop_r01.v0018/SCCA_Coop_R01_script.lua',
    Configurations = {
        ['standard'] = {
            teams = {
