...
ScenarioInfo = {
    ...
    size = {512, 512},
    map = '/maps/scca_coop_e04.v0020/SCCA_Coop_E04.scmap',
    save = '/maps/scca_coop_e04.v0020/SCCA_Coop_E04_save.lua',
    script = '/maps/scca_coop_e04.v0020/SCCA_Coop_E04_script.lua',
    Configurations = {
        ['standard'] = {
            teams = {
