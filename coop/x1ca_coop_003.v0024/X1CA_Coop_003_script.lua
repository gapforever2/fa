-- ****************************************************************************
-- **
-- **  File     :  /maps/x1ca_coop_003.v0024/X1CA_Coop_003_script.lua
...
local M1SeraphimAI = import('/maps/x1ca_coop_003.v0024/X1CA_Coop_003_m1seraphimai.lua')
local M1RhizaAI = import('/maps/x1ca_coop_003.v0024/X1CA_Coop_003_m1rhizaai.lua')
local M2SeraphimAI = import('/maps/x1ca_coop_003.v0024/X1CA_Coop_003_m2seraphimai.lua')
local M3PrincessAI = import('/maps/x1ca_coop_003.v0024/X1CA_Coop_003_m3princessai.lua')
local M3SeraphimAI = import('/maps/x1ca_coop_003.v0024/X1CA_Coop_003_m3seraphimai.lua')
local Objectives = import('/lua/ScenarioFramework.lua').Objectives
local OpStrings = import('/maps/x1ca_coop_003.v0024/X1CA_Coop_003_strings.lua')
...
local ScriptFile = '/maps/x1ca_coop_003.v0024/X1CA_Coop_003_script.lua'
...
-- Taunt Managers
----------------
local ZanNorthTM = TauntManager.CreateTauntManager('ZanNorthTM', '/maps/x1ca_coop_003.v0024/X1CA_Coop_003_Strings.lua')
local ThelWestTM = TauntManager.CreateTauntManager('ThelWestTM', '/maps/x1ca_coop_003.v0024/X1CA_Coop_003_Strings.lua')
local PrincTM = TauntManager.CreateTauntManager('PrincTM', '/maps/x1ca_coop_003.v0024/X1CA_Coop_003_Strings.lua')
local PrincNorthTM = TauntManager.CreateTauntManager('PrincNorthTM', '/maps/x1ca_coop_003.v0024/X1CA_Coop_003_Strings.lua')  -- for taunts related to north seraph from princess
local PrincWestTM = TauntManager.CreateTauntManager('PrincWestTM', '/maps/x1ca_coop_003.v0024/X1CA_Coop_003_Strings.lua')   -- for taunts related to west seraph from princess
local HQTM = TauntManager.CreateTauntManager('HQTM', '/maps/x1ca_coop_003.v0024/X1CA_Coop_003_Strings.lua')
local ExperimentalTM = TauntManager.CreateTauntManager('ExperimentalTM', '/maps/x1ca_coop_003.v0024/X1CA_Coop_003_Strings.lua')
...
function OnPopulate()
    ...
    ScenarioInfo.RhizaACU = ScenarioFramework.SpawnCommander('Rhiza', 'Rhiza', false, LOC '{i Rhiza}', false, false,
        {'ShieldAeon', 'EngineeringT2Aeon', 'T3EngineeringAeon', 'EnhancedSensorsAeon'})
...
function StartMission1()
	...
	ScenarioInfo.M1P1 = Objectives.CategoriesInArea(
        ...
        {                               -- target
            MarkUnits = true,
            Requirements = {
                {Area = 'M1_Naval_Base_Area', Category = categories.FACTORY, CompareOp = '<=', Value = 0, ArmyIndex = Seraphim},
            },
        }
	)
    ...
    ForkThread(
        function()
            ...
            ScenarioInfo.NorthACU = ScenarioFramework.SpawnCommander('Seraphim', 'M3_Seraphim_ACU_North', false, LOC '{i ZanAishahesh}', false, NorthACUDestroyed, 
                {'BlastAttackSeraphim', 'DamageStabilizationSeraphim', 'DamageStabilizationAdvancedSeraphim', 'RateOfFireSeraphim'})
