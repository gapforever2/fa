-- ****************************************************************************
-- **
-- **  File     : /maps/x1ca_coop_003.v0024/X1CA_Coop_003_m1rhizaai.lua
    ...
    opai = M1RhizaBase:AddOpAI('Colossus_1',
        {
            Amount = 1,
            KeepAlive = true,
            PlatoonAIFunction = {'/maps/x1ca_coop_003.v0024/X1CA_Coop_003_script.lua', 'ColossusPing'},
            MaxAssist = 5,
            Retry = true,
...
function M1RhizaBaseLandAttacks()
    ...
    local builder = {
        ...
        PlatoonAIFunction = {'/maps/x1ca_coop_003.v0024/X1CA_Coop_003_m1rhizaai.lua', 'M1RhizaAirAttackAI'},
    }
    ...
    for i = 1, 6 do
        opai = M1RhizaBase:AddOpAI('BasicLandAttack', 'Rhiza_AmphibiousDefense_' .. i,
            {
                MasterPlatoonFunction = {'/maps/x1ca_coop_003.v0024/X1CA_Coop_003_m1rhizaai.lua', 'RhizaNavalDEFENSEAI'},
                Priority = 110,
            }
        )
...
function M1RhizaBaseAirAttacks()
    ...
    opai = M1RhizaBase:AddOpAI('AirAttacks', 'M1_AirAttacks1',
        {
            MasterPlatoonFunction = {'/maps/x1ca_coop_003.v0024/X1CA_Coop_003_m1rhizaai.lua', 'M1RhizaAirAttackAI'},
            Priority = 1180,
        }
    )
...
function M1RhizaBaseNavalAttacks()
    ...
    opai = M1RhizaBase:AddNavalAI('Rhiza_NavalAttack2',
        {
            MasterPlatoonFunction = {'/maps/x1ca_coop_003.v0024/X1CA_Coop_003_m1rhizaai.lua', 'M1RhizaNavalAttackAI'},
            MaxFrigates = 15,
            MinFrigates = 15,
            Priority = 90,
        }
    ...
    local builder = {
        ...
        PlatoonAIFunction = {'/maps/x1ca_coop_003.v0024/X1CA_Coop_003_m1rhizaai.lua', 'RhizaNavalDEFENSEAI'},
    }
    ArmyBrains[Rhiza]:PBMAddPlatoon( builder )
    ...
    opai = M1RhizaBase:AddOpAI('Colossus_2',
        {
            Amount = 1,
            KeepAlive = true,
            PlatoonAIFunction = {'/maps/x1ca_coop_003.v0024/X1CA_Coop_003_m1rhizaai.lua', 'Colossus2AI'},
            MaxAssist = 5,
            Retry = true,
        }
    )
