...
ScenarioInfo = {
    ...
    size = {512, 512},
    map = '/maps/scca_coop_e02.v0020/SCCA_Coop_E02.scmap',
    save = '/maps/scca_coop_e02.v0020/SCCA_Coop_E02_save.lua',
    script = '/maps/scca_coop_e02.v0020/SCCA_Coop_E02_script.lua',
    Configurations = {
        ['standard'] = {
            teams = {
