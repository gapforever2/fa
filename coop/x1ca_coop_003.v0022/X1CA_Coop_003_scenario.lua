...
ScenarioInfo = {
    ...
    size = {2048, 1024},
    map = '/maps/x1ca_coop_003.v0022/X1CA_Coop_003.scmap',
    save = '/maps/x1ca_coop_003.v0022/X1CA_Coop_003_save.lua',
    script = '/maps/x1ca_coop_003.v0022/X1CA_Coop_003_script.lua',
    Configurations = {
        ['standard'] = {
            teams = {
