...
ScenarioInfo = {
    ...
    map_version = 3,
    size = {1024, 1024},
    map = '/maps/scca_coop_r04.v0020/SCCA_Coop_R04.scmap',
    save = '/maps/scca_coop_r04.v0020/SCCA_Coop_R04_save.lua',
    script = '/maps/scca_coop_r04.v0020/SCCA_Coop_R04_script.lua',
