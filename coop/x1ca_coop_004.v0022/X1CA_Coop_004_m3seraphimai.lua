-- ****************************************************************************
-- **
-- **  File     : /maps/x1ca_coop_004.v0022/X1CA_Coop_004_m3seraphimai.lua
...
function SeraphimM3NorthAirAttacks()
    ...
    if(Difficulty < 3) then
        ...
        opai = SeraphimM3North:AddOpAI('AirAttacks', 'M3_AirAttackN10',
            {
                MasterPlatoonFunction = {'/maps/x1ca_coop_004.v0022/X1CA_Coop_004_m3seraphimai.lua', 'M3AttackCDRAI'},
                Priority = 140,
            }
        )
        opai:SetChildQuantity('Bombers', quantity[Difficulty])
