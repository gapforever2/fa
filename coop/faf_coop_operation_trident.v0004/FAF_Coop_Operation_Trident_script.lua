...
-- Author: speed2
------------------------------------
local AeonAI = import('/maps/faf_coop_operation_trident.v0004/FAF_Coop_Operation_Trident_AeonAI.lua')
local CybranAI = import('/maps/faf_coop_operation_trident.v0004/FAF_Coop_Operation_Trident_CybranAI.lua')
local UEFAI = import('/maps/faf_coop_operation_trident.v0004/FAF_Coop_Operation_Trident_UEFAI.lua')
local Cinematics = import('/lua/cinematics.lua')
local CustomFunctions = import('/maps/faf_coop_operation_trident.v0004/FAF_Coop_Operation_Trident_CustomFunctions.lua')
local Objectives = import('/lua/SimObjectives.lua')
local OpStrings = import('/maps/faf_coop_operation_trident.v0004/FAF_Coop_Operation_Trident_strings.lua')
...
-- Taunt Managers
-----------------
local AeonTM = TauntManager.CreateTauntManager('AeonTM', '/maps/faf_coop_operation_trident.v0004/FAF_Coop_Operation_Trident_strings.lua')
local UEFTM = TauntManager.CreateTauntManager('UEFTM', '/maps/faf_coop_operation_trident.v0004/FAF_Coop_Operation_Trident_strings.lua')
...
function OnPopulate(scenario)
	...
	ScenarioUtils.CreateArmyGroup('Aeon', 'DeadUnits', true)
    -- Patrols
    -- Air
            ...
            if EntityCategoryContains(categories.COMMAND, unit) then
                ...
                if army == Player1 then
                    ScenarioInfo.Player1ACU = ScenarioFramework.SpawnCommander('Player1', 'Commander', false, true, true, PlayerDeath,
                        {'CoolingUpgradeCybran', 'StealthGeneratorCybran'})
                ...
                elseif army == Player2 then
                    ScenarioInfo.Player2ACU = ScenarioFramework.SpawnCommander('Player2', 'Commander', false, true, true, PlayerDeath,
                        {'EngineeringT2Cybran', 'ResourceAllocationCybran', 'NaniteTorpedoTubeCybran'})
                ...
                elseif army == Cybran then
                    ...
                    ScenarioInfo.CybranACU = ScenarioFramework.SpawnCommander('Cybran', 'Commander', false, 'Wyxe', true, PlayerDeath,
                        {'EngineeringT2Cybran', 'ResourceAllocationCybran', 'StealthGeneratorCybran'})
...
function IntroMission2()
    ...
    local upgrades = {
        {'ResourceAllocationAeon', 'HeatSinkAeon', 'ChronoDampenerAeon'},
        {'EngineeringT2Aeon', 'HeatSinkAeon', 'ChronoDampenerAeon'},
        {'ResourceAllocationAeon', 'EnhancedSensorsAeon', 'ShieldAeon', 'ShieldHeavyAeon'},
        {'EngineeringT2Aeon', 'EnhancedSensorsAeon', 'ShieldAeon', 'ShieldHeavyAeon'},
    }
