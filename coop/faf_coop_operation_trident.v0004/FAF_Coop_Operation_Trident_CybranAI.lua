...
local ThisFile = '/maps/faf_coop_operation_trident.v0004/FAF_Coop_Operation_Trident_CybranAI.lua'
    ...
    ArmyBrains[Cybran]:PBMAddPlatoon(
        {
            ...
            Priority = 200,
            PlatoonAIFunction = {'/maps/faf_coop_operation_trident.v0004/FAF_Coop_Operation_Trident_script.lua', 'M1ScoutPlatoonFormed'},
            BuildConditions = {
...
function M2ChangeACUEnhancements()
    M1CybranMainBase:SetACUUpgrades({'EngineeringT2Cybran', 'ResourceAllocationCybran', 'GAP_SelfRepairSystemCybran'})
end
