...
ScenarioInfo = {
    ...
    size = {512, 512},
    map = '/maps/scca_coop_a02.v0022/SCCA_Coop_A02.scmap',
    save = '/maps/scca_coop_a02.v0022/SCCA_Coop_A02_save.lua',
    script = '/maps/scca_coop_a02.v0022/SCCA_Coop_A02_script.lua',
    Configurations = {
        ['standard'] = {
            teams = {
