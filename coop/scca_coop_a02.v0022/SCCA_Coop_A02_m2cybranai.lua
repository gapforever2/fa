...
function EastNavalPatrolRebuild()
    ...
    local opai = CybranM2NorthBase:AddNavalAI('M2_East_Naval_Patrol',
        {
            MasterPlatoonFunction = {'/maps/scca_coop_a02.v0022/SCCA_Coop_A02_script.lua', 'NavalPatrolReinforceAI'},
            PlatoonData = {
...
function CybranM2SouthBaseNavalAttacks()
    ...
    opai:SetChildActive('T3', false)
    opai:AddBuildCallback('/maps/scca_coop_a02.v0022/SCCA_Coop_A02_script.lua', 'M2CreateCruiserDeathTrigger') -- Make sure the cruiser will get built only once
