-- ****************************************************************************
-- **
-- **  File     :  /maps/scca_coop_a02.v0022/SCCA_Coop_A02_script.lua
...
-- ****************************************************************************
local M2CybranAI = import('/maps/scca_coop_a02.v0022/SCCA_Coop_A02_m2cybranai.lua')
local M3CybranAI = import('/maps/scca_coop_a02.v0022/SCCA_Coop_A02_m3cybranai.lua')
local Objectives = import('/lua/SimObjectives.lua')
local OpStrings = import ('/maps/scca_coop_a02.v0022/SCCA_Coop_A02_strings.lua')
...
function IntroMission3()
    ...
    local upgrades = {
        {'CoolingUpgradeCybran'},
        {'CoolingUpgradeCybran', 'StealthGeneratorCybran'},
        {'CoolingUpgradeCybran', 'StealthGeneratorCybran', 'NaniteTorpedoTubeCybran'},
    }
