-- ****************************************************************************
-- **
-- **  File     : /maps/x1ca_coop_005.v0022/X1CA_Coop_005_m2fletcherai.lua
    ...
    opai = FletcherBase:AddOpAI('Fatboy_1',
        {
            ...
            PlatoonAIFunction = {'/maps/x1ca_coop_005.v0022/X1CA_Coop_005_m2fletcherai.lua', 'FletcherBaseAmphibiousAttacks'},
            MaxAssist = 15,
            Retry = true,
        }
    )
...
-- ========================================================================
    ...
    opai = FletcherBase:AddOpAI('BasicLandAttack', 'M2_LandAttack1' .. i,
        {
            MasterPlatoonFunction = {'/maps/x1ca_coop_005.v0022/X1CA_Coop_005_m2fletcherai.lua', 'FletcherLandPlatoonThread'},
            Priority = 100,
        }
    )
...
-- ========================================================================
    ...
    local builder = {
        ...
        PlatoonAIFunction = {'/maps/x1ca_coop_005.v0022/X1CA_Coop_005_m2fletcherai.lua', 'FletcherLandPlatoonThread'},
    }
...
-- ========================================================================
    ...
    opai = FletcherBase:AddOpAI('BasicLandAttack', 'M2_LandAttack4',
        {
            MasterPlatoonFunction = {'/maps/x1ca_coop_005.v0022/X1CA_Coop_005_m2fletcherai.lua', 'FletcherBaseAmphibiousAttacks'},
            Priority = 100,
        }
    )
...
function M2FletcherBaseAirAttacks()
    ...
    for i = 1, 2 do
        ...
        opai = FletcherBase:AddOpAI('AirAttacks', 'M2_AirAttack1' .. i,
            {
                MasterPlatoonFunction = {'/maps/x1ca_coop_005.v0022/X1CA_Coop_005_m2fletcherai.lua', 'FletcherAirPlatoonThread'},
                Priority = 100,
            }
        )
