-- ****************************************************************************
-- **
-- **  File     : /maps/x1ca_coop_005.v0022/X1CA_Coop_005_m3qaiai.lua
...
function QAIAirBaseAttacks()
    ...
    opai = QAIAirBase:AddOpAI('AirAttacks', 'M3_AirAirAttack13',
        {
            MasterPlatoonFunction = {'/maps/x1ca_coop_005.v0022/X1CA_Coop_005_m3qaiai.lua', 'M3AttackMegalithWaterAI'},
            Priority = 150,
        }
    )
    opai:SetChildQuantity('TorpedoBombers', quantity[Difficulty])
    opai:AddBuildCondition('/maps/x1ca_coop_005.v0022/X1CA_Coop_005_m3qaiai.lua', 'MegalithOnWater', {})

    -- sends 4, 8, 12 [gunships] at Megalith
    quantity = {4, 8, 12}
    opai = QAIAirBase:AddOpAI('AirAttacks', 'M3_AirAirAttack14',
        {
            MasterPlatoonFunction = {'/maps/x1ca_coop_005.v0022/X1CA_Coop_005_m3qaiai.lua', 'M3AttackMegalithLandAI'},
            Priority = 140,
        }
    )
    opai:SetChildQuantity('Gunships', quantity[Difficulty])
    opai:AddBuildCondition('/maps/x1ca_coop_005.v0022/X1CA_Coop_005_m3qaiai.lua', 'MegalithOnLand', {})

    -- sends 4, 8, 12 [torpedo bombers] at Player CDR
    quantity = {4, 8, 12}
    opai = QAIAirBase:AddOpAI('AirAttacks', 'M3_AirAirAttack15',
        {
            MasterPlatoonFunction = {'/maps/x1ca_coop_005.v0022/X1CA_Coop_005_m3qaiai.lua', 'M3AttackCDRWaterAI'},
            Priority = 150,
        }
    )
    opai:SetChildQuantity('TorpedoBombers', quantity[Difficulty])
    opai:AddBuildCondition('/maps/x1ca_coop_005.v0022/X1CA_Coop_005_m3qaiai.lua', 'CDROnWater', {})

    -- sends 4, 8, 12 [gunships] at Player CDR
    quantity = {4, 8, 12}
    opai = QAIAirBase:AddOpAI('AirAttacks', 'M3_AirAirAttack16',
        {
            MasterPlatoonFunction = {'/maps/x1ca_coop_005.v0022/X1CA_Coop_005_m3qaiai.lua', 'M3AttackCDRLandAI'},
            Priority = 140,
        }
    )
    opai:SetChildQuantity('Gunships', quantity[Difficulty])
    opai:AddBuildCondition('/maps/x1ca_coop_005.v0022/X1CA_Coop_005_m3qaiai.lua', 'CDROnLand', {})
