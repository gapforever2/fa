-- ****************************************************************************
-- **
-- **  File     : /maps/x1ca_coop_005.v0022/X1CA_Coop_005_script.lua
...
local M1Hex5AI = import('/maps/x1ca_coop_005.v0022/X1CA_Coop_005_m1hex5ai.lua')
local M2FletcherAI = import('/maps/x1ca_coop_005.v0022/X1CA_Coop_005_m2fletcherai.lua')
local M2Hex5AI = import('/maps/x1ca_coop_005.v0022/X1CA_Coop_005_m2hex5ai.lua')
local M3QAIAI = import('/maps/x1ca_coop_005.v0022/X1CA_Coop_005_m3qaiai.lua')
local Objectives = import('/lua/ScenarioFramework.lua').Objectives
local OpStrings = import('/maps/x1ca_coop_005.v0022/X1CA_Coop_005_strings.lua')
...
-- Taunt Managers
----------------
local QAITM = TauntManager.CreateTauntManager('QAITM', '/maps/x1ca_coop_005.v0022/X1CA_Coop_005_Strings.lua')
local Hex5TM = TauntManager.CreateTauntManager('Hex5TM', '/maps/x1ca_coop_005.v0022/X1CA_Coop_005_Strings.lua')
local BrackmanTM = TauntManager.CreateTauntManager('BrackmanTM', '/maps/x1ca_coop_005.v0022/X1CA_Coop_005_Strings.lua')
local FletcherTM = TauntManager.CreateTauntManager('FletcherTM', '/maps/x1ca_coop_005.v0022/X1CA_Coop_005_Strings.lua')
    ...
    ForkThread(
        function()
            ...
            ScenarioInfo.Hex5CDR = ScenarioFramework.SpawnCommander('Hex5', 'Hex5_Unit', false, LOC '{i Hex5}', true, false, 
                {'MicrowaveLaserGeneratorCybran', 'CoolingUpgradeCybran', 'StealthGeneratorCybran', 'CloakingGeneratorCybran'})
...
function EconomyDestroyed()
    if(ScenarioInfo.Hex5CDR and not ScenarioInfo.Hex5CDR.Dead) then
        ScenarioInfo.Hex5CDR:CreateEnhancement('StealthGeneratorCybranRemove')
        ScenarioInfo.Hex5CDR:CreateEnhancement('CloakingGeneratorCybranRemove')
    end
end
