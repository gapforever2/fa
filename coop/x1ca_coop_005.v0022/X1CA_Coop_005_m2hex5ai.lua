-- ****************************************************************************
-- **
-- **  File     : /maps/x1ca_coop_005.v0022/X1CA_Coop_005_m2hex5ai.lua
    ...
    opai = Hex5M2Base:AddOpAI('M2_Hex5_Spider_To_Player',
        {
            Amount = quantity[Difficulty],
            KeepAlive = true,
            PlatoonAIFunction = {'/maps/x1ca_coop_005.v0022/X1CA_Coop_005_m2hex5ai.lua', 'AddExperimentalToPlatoon'},
            PlatoonData = {
