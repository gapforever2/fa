-- ****************************************************************************
-- **
-- **  File     :  /maps/scca_coop_a04.v0022/SCCA_Coop_A04_script.lua
...
-- ****************************************************************************
local M1CybranAI = import('/maps/scca_coop_a04.v0022/SCCA_Coop_A04_m1cybranai.lua')
local M1NexusAI = import('/maps/scca_coop_a04.v0022/SCCA_Coop_A04_m1nexusai.lua')
local M2CybranAI = import('/maps/scca_coop_a04.v0022/SCCA_Coop_A04_m2cybranai.lua')
local Objectives = import('/lua/SimObjectives.lua')
local OpStrings = import('/maps/scca_coop_a04.v0022/SCCA_Coop_A04_Strings.lua')
...
function OnStart(self)
    ...
    ScenarioFramework.RestrictEnhancements({'TeleporterAeon', 'T3EngineeringAeon', 'ShieldHeavyAeon', 'ResourceAllocationAdvancedAeon'})
...
function IntroMission2()
    ...
    ScenarioFramework.RestrictEnhancements({'TeleporterAeon', 'T3EngineeringAeon', 'ShieldHeavyAeon'})
