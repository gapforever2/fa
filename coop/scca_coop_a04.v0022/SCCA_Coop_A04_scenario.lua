...
ScenarioInfo = {
    ...
    size = {1024, 1024},
    map = '/maps/scca_coop_a04.v0022/SCCA_Coop_A04.scmap',
    save = '/maps/scca_coop_a04.v0022/SCCA_Coop_A04_save.lua',
    script = '/maps/scca_coop_a04.v0022/SCCA_Coop_A04_script.lua',
    Configurations = {
        ['standard'] = {
            teams = {
