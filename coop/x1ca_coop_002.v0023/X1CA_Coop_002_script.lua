-- ****************************************************************************
-- **
-- **  File     :  /maps/x1ca_coop_002.v0023/X1CA_Coop_002_script.lua
...
local M1LoyalistAI = import('/maps/x1ca_coop_002.v0023/X1CA_Coop_002_m1loyalistai.lua')
local M2LoyalistAI = import('/maps/x1ca_coop_002.v0023/X1CA_Coop_002_m2loyalistai.lua')
local M1OrderAI = import('/maps/x1ca_coop_002.v0023/X1CA_Coop_002_m1orderai.lua')
local M2OrderAI = import('/maps/x1ca_coop_002.v0023/X1CA_Coop_002_m2orderai.lua')
local M4OrderAI = import('/maps/x1ca_coop_002.v0023/X1CA_Coop_002_m4orderai.lua')
local M2QAIAI = import('/maps/x1ca_coop_002.v0023/X1CA_Coop_002_m2qaiai.lua')
local M3QAIAI = import('/maps/x1ca_coop_002.v0023/X1CA_Coop_002_m3qaiai.lua')
local M4QAIAI = import('/maps/x1ca_coop_002.v0023/X1CA_Coop_002_m4qaiai.lua')
local Objectives = import('/lua/ScenarioFramework.lua').Objectives
local OpStrings = import('/maps/x1ca_coop_002.v0023/X1CA_Coop_002_Strings.lua')
...
-- Taunt Managers
----------------
local CeleneTM = TauntManager.CreateTauntManager('CeleneTM', '/maps/x1ca_coop_002.v0023/X1CA_Coop_002_Strings.lua')
local QAITM = TauntManager.CreateTauntManager('QAITM', '/maps/x1ca_coop_002.v0023/X1CA_Coop_002_Strings.lua')
    ...
    ForkThread(
        function()
            ...
            ScenarioInfo.QAICommander = ScenarioFramework.SpawnCommander('QAI', 'M4_QAI_Commander', false, LOC '{i QAI}', true, false,
                {'StealthGeneratorCybran', 'MicrowaveLaserGeneratorCybran', 'EngineeringT2Cybran', 'T3EngineeringCybran'})
