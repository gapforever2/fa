-- ****************************************************************************
-- **
-- **  File     : /maps/x1ca_coop_002.v0023/X1CA_Coop_002_m1loyalistai.lua
...
function LoyalistM1MainBaseLandAttacks()
    ...
    opai = LoyalistM1MainBase:AddOpAI('BasicLandAttack', 'M1_BasicLandAttack',
        {
            MasterPlatoonFunction = {'/maps/x1ca_coop_002.v0023/X1CA_Coop_002_m1loyalistai.lua', 'LoyalistM1MainLandAttacksAI'},
        }
    )
