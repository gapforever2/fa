-- ****************************************************************************
-- **
-- **  File     : /maps/x1ca_coop_002.v0023/X1CA_Coop_002_m2orderai.lua
...
function OrderM2NorthBaseAirAttacks()
    ...
    opai = OrderM2NorthBase:AddOpAI('AirAttacks', 'M2_AirAttacks1',
        {
            MasterPlatoonFunction = {'/maps/x1ca_coop_002.v0023/X1CA_Coop_002_m2orderai.lua', 'M2OrderAirAttackAI'},
            Priority = 100,
        }
    )
...
function OrderM2NorthBaseLandAttacks()
    ...
    opai = OrderM2NorthBase:AddOpAI('BasicLandAttack', 'M2_LandAttack1',
        {
            MasterPlatoonFunction = {'/maps/x1ca_coop_002.v0023/X1CA_Coop_002_m2orderai.lua', 'M2OrderLandAttackAI'},
            Priority = 100,
        }
    )
