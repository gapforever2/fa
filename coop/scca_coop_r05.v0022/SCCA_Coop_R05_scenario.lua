...
ScenarioInfo = {
    ...
    size = {1024, 1024},
    map = '/maps/scca_coop_r05.v0022/SCCA_Coop_R05.scmap',
    save = '/maps/scca_coop_r05.v0022/SCCA_Coop_R05_save.lua',
    script = '/maps/scca_coop_r05.v0022/SCCA_Coop_R05_script.lua',
    Configurations = {
        ['standard'] = {
            teams = {
