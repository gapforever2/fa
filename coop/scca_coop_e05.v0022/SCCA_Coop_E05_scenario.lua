...
ScenarioInfo = {
    ...
    size = {1024, 1024},
    map = '/maps/scca_coop_e05.v0022/SCCA_Coop_E05.scmap',
    save = '/maps/scca_coop_e05.v0022/SCCA_Coop_E05_save.lua',
    script = '/maps/scca_coop_e05.v0022/SCCA_Coop_E05_script.lua',
    Configurations = {
        ['standard'] = {
            teams = {
