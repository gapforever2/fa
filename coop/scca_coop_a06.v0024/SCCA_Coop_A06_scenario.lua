...
ScenarioInfo = {
    ...
    starts = true,
    size = {1024, 1024},
    map = '/maps/scca_coop_a06.v0024/SCCA_Coop_A06.scmap',
    save = '/maps/scca_coop_a06.v0024/SCCA_Coop_A06_save.lua',
    script = '/maps/scca_coop_a06.v0024/SCCA_Coop_A06_script.lua',
    norushradius = 0,
    Configurations = {
        ['standard'] = {
            teams = {
