...
Unit_Description_0107="Personal Cloaking further hiding the ACU from optical sensors and massively boosts HP. Countered by omni sensors.\n\nAdditional health: +12000\n\nEnergy upkeep: 50 --> 3000 (energy/s)"
...
Unit_Description_0114="Kraken-class weapon.\nEquips the ACU with a long-range torpedo tube and sonar sensor.\n\nTorpedo damage: 60\nReload between salvos: 4 sec\nReload between shots: 0.8 sec\nRange: 60\nSplash: 0.1\nSonar radius: 63\nTorpedoes are uninterceptable: cannot be shot down or diverted by anti-torpedo defenses"
Unit_Description_CybranStealthField="Generates a stealth field that conceals nearby allied units from enemy radar and sonar. Does not stealth the ACU itself. Requires energy to run.\n\nRadar stealth radius: 24\nSonar stealth radius: 24\nEnergy upkeep: 250/s"
...
Unit_Description_0118="Increases the firing range of the main and secondary guns.\nFiring range 25-->35"
...
Unit_Description_0123="Personal Stealth hiding the SACU from radar.\nUnmasked by all-wave sensor or visual detection.\nCosts energy to run (-100)."
...
Unit_Description_0007_gaf="Increases the sensor range of the ACU, especially: Radar, Omni radar, Sight.\n\nRadar radius: 0 --> 80.\nOmni sensor radius: 16 --> 35.\nView radius: 26 --> 60.\n\nEnergy consumption: -50."
